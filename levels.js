module.exports.run = (client) => {
	...
	client.on('message', message => {
		...
		if (userInfo.get("booster") == true) return addXP(guild.id, message.author.id, 50 + getRandomInt(40), message);
		addXP(guild.id, message.author.id, 25 + getRandomInt(20), message)
	})
